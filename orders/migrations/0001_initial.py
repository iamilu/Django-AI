    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('New', 'New'), ('Accepted', 'Accepted'), ('Completed', 'Completed'), ('Cancelled', 'Cancelled'), ('Pending', 'Pending'), ('Refunded', 'Refunded'), ('Shipped', 'Shipped'), ('Returned', 'Returned'), ('Processing', 'Processing'), ('Delivered', 'Delivered'), ('Paid', 'Paid'), ('Unpaid', 'Unpaid')], default='New', max_length=50)),
